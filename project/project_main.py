...
# Milestone 2: Vocational Attendance Tracker
...
def get_individual_record():
    ...
    class_name = input("Enter the vocational class: ").strip()
...
def get_overall_class_record():
    ...
    class_name = input("\nEnter the vocational class: ").strip()

    while class_name == "":
        print("The vocational class cannot be blank.")
        class_name = input("Enter the vocational class: ").strip()
